...
#include "Pracownik.h"
/*
void zapotrzebowanie_proces(const vector<operacja>& proc, float& czas_spawacz, float& czas_monter,
...
ilosc_pracownikow licz_zapotrzebowanie(const vector<operacja>& procLL_V1, 
...
vector<Pracownik> stworz_pracownikow(ilosc_pracownikow wyliczeni_pracownicy)
{	
